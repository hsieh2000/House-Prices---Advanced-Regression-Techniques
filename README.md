...
Back to the point, I decide to keep using MSELoss to evaluate the perfoemance of the model at the end.  I try different combinations of hypermeters and achitecture of the network and figure out several principles of machine learning, such as the deeper model needs smaller learning rate to prevent severe oscillations and bigger batch size normally will get lower loss value. I do other adjustments to see how does these effect the performance, like chagning activation function, applying L2 regulizer to increase the generality of the model.  

Finally, after countless tuning and adjustment, I successfully improve public score to 0.13676, it's about in the top 30% of the leaderboard, there are definitly lots of ways to make it better though. 
