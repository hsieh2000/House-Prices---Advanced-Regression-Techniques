...
Adam is the combination of RMSProp + Momentum. In RMSProp, the weight θ(t+1) will be updated by  `θ(t) - η/σ(t)*g(t)`, so when g gradually turns small,  `η/σ(t)` will become an extremely small value,
